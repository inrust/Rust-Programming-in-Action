...
pub fn bubble_sort<T: Copy + cmp::PartialOrd>(arr: &mut Vec<T>) {
...
pub fn selection_sort<T: cmp::PartialOrd>(arr: &mut Vec<T>) {
    if arr.is_empty() { return; }
...
pub fn heap_sort<T: cmp::PartialOrd>(arr: &mut Vec<T>) {
    build_heap(arr);
...
pub fn merge_sort<T: Copy + cmp::PartialOrd>(arr: &mut Vec<T>) {
    if arr.is_empty() { return; }
...
pub fn quick_sort<T: cmp::PartialOrd>(arr: &mut Vec<T>) {
    if arr.is_empty() { return; }
